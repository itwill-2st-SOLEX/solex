...
public class ApprovalRestController {
	...
	// 결재할 기안서 상세보기 모달창
    @GetMapping("/")
    public String getTodoDocumentDetail(@RequestParam Long docId, @RequestParam String docTypeCode) {
    	// 로그인 아이디 가져오기 - 나중에 Spring Security 이용해서 가져와야됨
    	Long loginEmpId = 1L;
    	
    	approvalService.getTodoDocumentDetail(docId, docTypeCode, loginEmpId);
    	return "";
    }
